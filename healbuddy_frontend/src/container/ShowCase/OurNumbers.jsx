    ...
    <div className='animate-fade-in-up duration-200 ease-linear p-3 max-sm:p-1 flex flex-col max-md:items-center max-md:justify-center bg-white rounded-3xl my-5'>
      ...
      <div className='flex flex-col items-center max-md:items-center justify-center'>
        ...
        <div className='flex pb-3 max-md:flex-col'>
          ...
          <div className='bg-mainColor max-md:my-3 rounded-xl p-5 flex flex-col justify-center mx-2 flex flex-col items-center justify-center hover:shadow-xl transition-all duration-300 cursor-pointer'>
            <RiMentalHealthFill fontSize={150} />
            <h1 className='text-[45px] max-sm:text-3xl font-bold'>{healersCount}+</h1>
            <h1 className='text-[35px]  max-md:text-3xl max-sm:text-2xl max-lg:text-2xl font-bold'>Healer</h1>
            <p>Lorem ipsum is typically a corrupted version of De finibus bonorum et malorum, a 1st-century BC text by the Roman statesman and philosopher Cicero, with words altered,</p>
          </div>
          <div className='bg-mainColor max-md:my-3 rounded-xl p-5 flex flex-col justify-center mx-2 flex flex-col items-center justify-center hover:shadow-xl transition-all duration-300 cursor-pointer'>
            <GiHealthIncrease fontSize={150} />
            <h1 className='text-[45px] max-sm:text-3xl font-bold'>{healedCount}+</h1>
            <h1 className='text-[35px]  max-md:text-3xl max-sm:text-2xl max-lg:text-2xl font-bold'>Healed</h1>
            <p>Lorem ipsum is typically a corrupted version of De finibus bonorum et malorum, a 1st-century BC text by the Roman statesman and philosopher Cicero, with words altered,</p>
          </div>
        </div>
      </div>
